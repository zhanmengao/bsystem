...
public class MqClient {
    ...
    public synchronized boolean connect()
    {
        ...
        String userName = "VEMQTest"; //MQ实例名称
        String mqTopic = "VETopicTest"; //topic名称
        String mqSub = "VEDing"; // 订阅名称
    ...
    private void resetOptions(){
        String userName = "VEMQTest"; //MQ实例名称
        String accessKey = "QrLcJHdXY6okDNi9wfSlWsrU899utChn6yGvuim4AvM="; //MQ access_key
