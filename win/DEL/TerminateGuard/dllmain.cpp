...
{			
	...
	wsprintf( outText,L"%ls :: DialogBoxIndirectParamW ==> style:%lu dwExtendedStyle::%lu c:%d y:%d cx:%d cy:%d cdit:%d dwInitPara: %l",
		modname ,
...
BOOL  HOOK()
{
	...
	{
		OutputDebugStringW(TEXT("MH_Initialize Error"));
		return FALSE;
	}
/**	
	// Create a hook
	...
	{
		OutputDebugStringW(TEXT("MH_CreateHook CreateProcessA Error"));
		return FALSE;
	...
	{
		OutputDebugStringW(TEXT("MH_CreateHook CreateProcessW Error"));
		return FALSE;
	}
**/		
	if (MH_CreateHook(
...
/**
	...
	{
		OutputDebugStringW(TEXT("MH_EnableHook CreateProcessA Error"));
		return FALSE;
	}
		
	if (MH_EnableHook(&CreateProcessW) != MH_OK)
	{
		OutputDebugStringW(TEXT("MH_EnableHook CreateProcessW Error"));
		return FALSE;
	}
**/	
...
/**	
	...
	{
		OutputDebugStringW(TEXT("MH_DisableHook CreateProcessA Error"));
		return FALSE;
	}
	...
	if (MH_DisableHook(&CreateProcessW) != MH_OK)
	{
		...
		OutputDebugStringW(TEXT("MH_DisableHook CreateProcessW Error"));
		return FALSE;
	}
**/	
	...
	{
		OutputDebugStringW(TEXT("MH_Uninitialize Error"));
		return FALSE;
	}
