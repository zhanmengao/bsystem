...
/***
*int vfscanf_fn(stream, format, ...) - read formatted data from stream
*
*Purpose:
        ...
        )
{
        ...
        return vfscanf_fn(_input_l, stream, format, NULL, arglist);
}
        ...
        )
{
        ...
        return vfscanf_fn(_input_l, stream, format, plocinfo, arglist);
}
        ...
        )
{
        va_list arglist;
        va_start(arglist, format);
        return vfscanf_fn(_input_s_l, stream, format, NULL, arglist);
}
        ...
        )
{
        va_list arglist;
        va_start(arglist, plocinfo);
        return vfscanf_fn(_input_s_l, stream, format, plocinfo, arglist);
}
