...
/***
*int vscanf_fn(format, ...) - read formatted data from stdin
*
*Purpose:
        ...
        )
{
        ...
        return vscanf_fn(_input_l, format, plocinfo, arglist);
}
        ...
        )
{
        va_list arglist;
        va_start(arglist, format);
        return vscanf_fn(_input_s_l, format, NULL, arglist);
}
        ...
        )
{
        va_list arglist;
        va_start(arglist, plocinfo);
        return vscanf_fn(_input_s_l, format, plocinfo, arglist);
}
