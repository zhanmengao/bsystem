...
// _CRT_APP is defined if the CRT is targeting MSDK. For both cases, the surface area of the CRT
...
// Because we cannot include pplconcrt.h we need to typedef the basic primitives for cancellation token
namespace Concurrency
{
