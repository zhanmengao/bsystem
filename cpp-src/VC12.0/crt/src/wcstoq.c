...
extern "C" long long _CRTIMP __cdecl wcstoll(
    const wchar_t *nptr,
    wchar_t **endptr,
    int ibase
    )
{
    return _wcstoi64(nptr, endptr, ibase);
}
...
extern "C" long long _CRTIMP __cdecl _wcstoll_l(
    const wchar_t *nptr,
    wchar_t **endptr,
    int ibase,
    _locale_t plocinfo
...
{
    return _wcstoi64_l(nptr, endptr, ibase, plocinfo);
}
...
extern "C" intmax_t _CRTIMP __cdecl wcstoimax (
    const wchar_t *nptr,
    wchar_t **endptr,
    int ibase
    )
...
extern "C" intmax_t _CRTIMP __cdecl _wcstoimax_l (
    const wchar_t *nptr,
    wchar_t **endptr,
    int ibase,
    _locale_t plocinfo
...
extern "C" uintmax_t _CRTIMP __cdecl _wcstoumax_l (
    const wchar_t *nptr,
    wchar_t **endptr,
    int ibase,
    _locale_t plocinfo
...
extern "C" long double _CRTIMP __cdecl wcstold (
    const wchar_t *nptr,
    wchar_t **endptr
    )
{
...
extern "C" float _CRTIMP __cdecl wcstof (
    const wchar_t *nptr,
    wchar_t ** endptr
    )
{
    return _wcstof_l(nptr, endptr, NULL);
}
