...
*
*Purpose:
*       defines __get_qualified_locale_downlevel - get complete locale information
*
*******************************************************************************/
...
//  function prototypes
BOOL __cdecl __get_qualified_locale_downlevel(const LPLC_STRINGS lpInStr, UINT* lpOutCodePage, LPLC_STRINGS lpOutStr);
static BOOL TranslateName(const LOCALETAB *, int, const wchar_t **);

static void GetLcidFromLangCountry (_psetloc_downlevel_struct _psetloc_downlevel_data);
static BOOL CALLBACK LangCountryEnumProc(LPWSTR);

static void GetLcidFromLanguage (_psetloc_downlevel_struct _psetloc_downlevel_data);
static BOOL CALLBACK LanguageEnumProc(LPWSTR);

static void GetLcidFromCountry (_psetloc_downlevel_struct _psetloc_downlevel_data);
static BOOL CALLBACK CountryEnumProc(LPWSTR);

static void GetLcidFromDefault (_psetloc_downlevel_struct _psetloc_downlevel_data);

static int ProcessCodePage (LPWSTR lpCodePageStr, _psetloc_downlevel_struct _psetloc_downlevel_data);
static BOOL TestDefaultCountry(LCID);
static BOOL TestDefaultLanguage (LCID lcid, BOOL bTestPrimary, _psetloc_downlevel_struct _psetloc_downlevel_data);

static LCID LcidFromHexString(LPWSTR);
static int GetPrimaryLen(LPWSTR);

//  non-NLS language string table
extern const LOCALETAB __rg_language[];
extern const int __rg_language_count;

//  non-NLS country/region string table
extern const LOCALETAB __rg_country[];
extern const int __rg_country_count;
...
/***
*BOOL __get_qualified_locale_downlevel - return fully qualified locale
*
*Purpose:
...
BOOL __cdecl __get_qualified_locale_downlevel(const LPLC_STRINGS lpInStr, UINT* lpOutCodePage, LPLC_STRINGS lpOutStr)
{
    ...
    _setloc_downlevel_struct downlevel_setloc;
    _psetloc_downlevel_struct _psetloc_downlevel_data;

    memset(&downlevel_setloc, '\0', sizeof(_setloc_downlevel_struct));
    _psetloc_downlevel_data = _getptd()->_setloc_downlevel_data = &downlevel_setloc;
    ...
    iCodePage = ProcessCodePage(lpInStr ? lpInStr->szCodePage: NULL, _psetloc_downlevel_data);
...
*
*******************************************************************************/
static BOOL CALLBACK LangCountryEnumProc (LPWSTR lpLcidString)
{
    _psetloc_struct    _psetloc_data = &_getptd()->_setloc_data;
    _psetloc_downlevel_struct    _psetloc_downlevel_data = _getptd()->_setloc_downlevel_data;
...
*
*******************************************************************************/
static BOOL CALLBACK LanguageEnumProc (LPWSTR lpLcidString)
{
    _psetloc_struct    _psetloc_data = &_getptd()->_setloc_data;
    _psetloc_downlevel_struct    _psetloc_downlevel_data = _getptd()->_setloc_downlevel_data;
...
*
*******************************************************************************/
static BOOL CALLBACK CountryEnumProc (LPWSTR lpLcidString)
{
    _psetloc_struct    _psetloc_data = &_getptd()->_setloc_data;
    _psetloc_downlevel_struct    _psetloc_downlevel_data = _getptd()->_setloc_downlevel_data;
    LCID    lcid = LcidFromHexString(lpLcidString);
...
*
*******************************************************************************/
static LCID LcidFromHexString (LPWSTR lpHexString)
{
    wchar_t    ch;
    DWORD   lcid = 0;
...
*
*******************************************************************************/
static int GetPrimaryLen (LPWSTR pchLanguage)
{
    int     len = 0;
    wchar_t    ch;
