...
namespace details
{
    static _UnobservedExceptionHandler s_unobservedExceptionHandler = NULL;
    ...
    _CRTIMP void _ReportUnobservedException()
    {
        if (s_unobservedExceptionHandler != NULL)
        {
            _UnobservedExceptionHandler Handler = (_UnobservedExceptionHandler)Security::DecodePointer(s_unobservedExceptionHandler);
            Handler();
        }
        ...
        __crtTerminateProcess(STATUS_FATAL_APP_EXIT);
#endif /* defined(_M_IX86) || defined(_M_X64) */
    }

    _CRTIMP void _SetUnobservedExceptionHandler(_UnobservedExceptionHandler Handler)
    {
        s_unobservedExceptionHandler = (_UnobservedExceptionHandler)Security::EncodePointer(Handler);
    }
