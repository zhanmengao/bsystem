...
/***
*int vfwscanf_fn(stream, format, ...) - read formatted data from stream
*
*Purpose:
        ...
        )
{
        ...
        return vfwscanf_fn(_winput_l, stream, format, NULL, arglist);
}
        ...
        )
{
        ...
        return vfwscanf_fn(_winput_l, stream, format, plocinfo, arglist);
}
        ...
        )
{
        va_list arglist;
        va_start(arglist, format);
        return vfwscanf_fn(_winput_s_l, stream, format, NULL, arglist);
}
        ...
        )
{
        va_list arglist;
        va_start(arglist, plocinfo);
        return vfwscanf_fn(_winput_s_l, stream, format, plocinfo, arglist);
}
