...
namespace details
{
    ...
    public:
        ...
        /// </summary>
        static void CALLBACK FireTimer(PTP_CALLBACK_INSTANCE instance, void* context, PTP_TIMER timer)
        {
        ...
        /// </summary>
        static void CALLBACK FireTimerXP(PVOID pContext, BOOLEAN fTimedOut)
        {
