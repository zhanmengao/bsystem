        ...
        DWORD fileflags)
{
...
#endif  /* _CRT_APP */
        {
            ...
            pfnCreateFile2 = &CreateFile2;
#else   /* defined (_CORESYS) || defined (_CRT_APP) */
            pfnCreateFile2 = (PFN_CreateFile2)GetProcAddress(
                GetModuleHandleW(L"kernel32.dll"), "CreateFile2");

            if (pfnCreateFile2 == NULL)
                return (HANDLE)-1;
