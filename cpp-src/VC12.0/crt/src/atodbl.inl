...
#ifdef _SAFECRT_IMPL
int __crt_safecrt_atoflt(_CRT_FLOAT *d, const char *str, char dec_point, char **end_ptr)
#else  /* _SAFECRT_IMPL */
int __crt_atoflt_l(_CRT_FLOAT *d, const char *str, _locale_t plocinfo, char **end_ptr)
#endif  /* _SAFECRT_IMPL */
{
    const char *EndPtr;
    _LDBL12 ld12;
...
#ifdef _SAFECRT_IMPL
int _safecrt_atoflt(_CRT_FLOAT *d, const char *str, char dec_point)
#else  /* _SAFECRT_IMPL */
int _atoflt_l(_CRT_FLOAT *d, const char *str, _locale_t plocinfo)
#endif  /* _SAFECRT_IMPL */
{
#ifdef _SAFECRT_IMPL
    return __crt_safecrt_atoflt(d, str, dec_point, NULL);
#else  /* _SAFECRT_IMPL */
    return __crt_atoflt_l(d, str, plocinfo, NULL);
#endif  /* _SAFECRT_IMPL */
}

#ifndef _SAFECRT_IMPL
int _atoflt(_CRT_FLOAT *d, const char *str)
{
