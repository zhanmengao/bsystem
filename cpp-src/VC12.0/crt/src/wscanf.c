        ...
        )
{
        ...
        return vwscanf_fn(_winput_l, format, NULL, arglist);
}
        ...
        )
{
        ...
        return vwscanf_fn(_winput_l, format, plocinfo, arglist);
}
        ...
        )
{
        va_list arglist;
        va_start(arglist, format);
        return vwscanf_fn(_winput_s_l, format, NULL, arglist);
}
        ...
        )
{
        va_list arglist;
        va_start(arglist, plocinfo);
        return vwscanf_fn(_winput_s_l, format, plocinfo, arglist);
}
