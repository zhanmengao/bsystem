...
_Check_return_ int __cdecl __crt_atoflt_l(_Out_ _CRT_FLOAT * _Result, _In_z_ const char * _Str,_In_opt_ _locale_t _Locale, _Out_opt_ _Deref_post_z_ char **end_ptr);
