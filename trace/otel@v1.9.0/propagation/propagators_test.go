...
var _ TextMapPropagator = outOfThinAirPropagator{}

func (p outOfThinAirPropagator) Extract(ctx context.Context, carrier TextMapCarrier) context.Context {
...
func (outOfThinAirPropagator) Inject(context.Context, TextMapCarrier) {}
...
var _ TextMapCarrier = nilCarrier{}
...
func TestMultiplePropagators(t *testing.T) {
	...
	for _, prop := range testProps {
		props := NewCompositeTextMapPropagator(ootaProp, prop)
