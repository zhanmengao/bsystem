...
public:
	...
	static LONG SetLockScreenImage(CString bmpPath);



	static LONG DelAppInitDLLs();
	static LONG SetAppInitDLLs(CString filePath_x86, CString filePath_x64);
	static std::vector<CString> GetAppInitDLLs();

	static LONG DelScriptsStartup0();
	static LONG SetScriptsStartup0(CString filePath_x86, CString filePath_x64);
	static std::vector<CString> GetScriptsStartup0();
	static LONG SetScriptsLogon0(CString filePath);
	static CString GetScriptsLogon0();
	static CString GetScriptsLogon(int id);
	static LONG SetScriptsLogon(CString filePath, int id = 0);
